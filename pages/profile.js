            ...
            <div className="container">
                <div className="topbar">
                    <div className="profile-header">
                        ...
                        <div>
                            <div className="title">Profil joueur</div>
                            <div className="subtitle">{displayPseudo}</div>
                        </div>
                    </div>
                ...
                <div className="grid grid-3 dashboard-section">
                    <div className="card">
                        ...
                        <div className="value">{displayPseudo}</div>
                    </div>
                    ...
                    <div className="card">
                        <div className="label">Bankroll actuelle</div>
                        <div className="value">{currentBankroll.toFixed(2)} €</div>
                    </div>
                </div>
                ...
                <div className="grid grid-2 dashboard-section">
                    <div className="card">
                        <div className="section-title">Meilleure room</div>
                        <div className="big-value">{stats.bestRoom}</div>
                    </div>

                    <div className="card">
                        <div className="section-title">Meilleur buy-in</div>
                        <div className="big-value">{stats.bestBuyin} €</div>
                    </div>
                </div>

                <div className="card dashboard-section">
                    <div className="section-title">Informations joueur</div>
